...
def baseline_process(n_hours, K, masked_value, split_1, split_2, inputfile):
    # ==================== import dataset ====================
    dataset = pd.read_csv(inputfile+'/Merged-update_hourly.csv', index_col=0)
...
def gcn_process(n_hours, K, masked_value, split_1, split_2, inputfile):
    # ==================== import dataset ====================
    #dataset = pd.read_csv('data/Merged-update_hourly.csv', index_col=0)
    dataset = pd.read_csv(inputfile+'/Merged-update_hourly.csv', index_col=0)
    dataset.fillna(0, inplace=True)
